        ...
        <div class="pagination  pagination-centered">
            <ul>
                <c:forEach var="i" begin="1" end="${allPage}" step="1">
                        <s:form cssClass="form-inline"  name="genres" modelAttribute="genres" action="genres.html" method="post" >
                            <s:input id="id"  type="hidden" value="${genres.id}"   path="id"  />
                            <s:input id="genre"  type="hidden" value="${genres.genre}" path="genre" />
                            <input name="page" type="hidden" value="${i}"/>
                          <input class="btn btn-small" type="submit" value="${i}"/>
                    </s:form>
                </c:forEach>
            </ul>
        </div>
